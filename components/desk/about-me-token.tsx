      ...
      >
        ...
        >
          ...
          <div className="absolute bottom-2 left-0 right-0 text-center">
            <div className="font-typewriter text-[6px] text-sepia/50 tracking-wider mb-0.5">WHO AM I</div>
            <span className="font-handwriting text-xs text-sepia/80">About Me</span>
          </div>
        </div>

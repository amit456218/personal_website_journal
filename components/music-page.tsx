    ...
    <div className="min-h-screen bg-paper-dark">
      ...
      <div className="relative pt-24 pb-16 px-6 md:px-12">
        <div className="max-w-2xl mx-auto">
          ...
          >
            <h1 className="font-serif text-4xl text-ink mb-4">Music</h1>
          ...
          >
            <p className="font-serif text-lg text-ink/80 leading-relaxed text-center">
              Coming soon... a collection of playlists, favorite albums, and the songs that have accompanied me on my travels.
            </p>
          </motion.div>
        </div>
      </div>
